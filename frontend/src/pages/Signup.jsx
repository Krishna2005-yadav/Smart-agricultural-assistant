...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        // Combine first and last name for username since backend expects username
        const username = `${firstName} ${lastName}`.trim();

        try {
            const result = await signup(email, username || email.split('@')[0], password);
            if (result.success) {
                navigate('/login');
            } else {
                ...
                <div className="auth-form-panel">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="auth-social-btns">
                            ...
                            <button type="button" className="btn-social">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.04 2.26-.79 3.49-.76 2.04.16 3.49 1.07 4.19 2.22-3.41 1.96-2.77 6.3 1.02 7.79-.81 1.18-1.74 2.12-2.83 3.08l-.95-.16zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" /></svg>
                                Apple
                            </button>
                        </div>
                    </form>
